...
>> I prefered to use nano, because its commands are more similar to the ones I'm used to.
...
>> I like the fact that vim can be used for terminal and graphical editor.
